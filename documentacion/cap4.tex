...
sistema que disponga de un navegador web que cumpla los estándares 2.0 \cursiva{WCC}
...
\figura{casos_uso/funciones_principales.png}{scale=0.35}{Diagrama de casos de
...
\item{Gestión de usuarios}
  ...
  \item Notificación de registro por e-mail
    \figura{casos_uso/gestion_usuarios.png}{scale=0.35}{Diagrama de casos de uso
...
\item{Gestión económica}
  ...
  \item Fijar precio de venta de entradas
    \figura{casos_uso/gestion_economica.png}{scale=0.35}{Diagrama de casos de
...
\item{Gestión deportiva}
  ...
  \item Planificación de entrenamientos
    \figura{casos_uso/gestion_deportiva.png}{scale=0.35}{Diagrama de casos de
...
\item{Gestión de campeonatos}
  ...
  \item Composición de calendarios
    \figura{casos_uso/gestion_campeonatos.png}{scale=0.35}{Diagrama de casos de
