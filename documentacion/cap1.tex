...
en la titulación de \cursiva{Ingeniería Técnica en Informática de
  Gestión} y a la vez aprender a desarrollar bajo una novedosa tecnología web
basada en un \programa{framework} basado en el patrón
...
lenguaje de \programa{script} llamado \programa{Ruby} que tiene
...
\begin{itemize}
  \item \negrita{Gestión de usuarios:} todas las herramientas
    necesarias para identificar a cada usuario de nuestra aplicación
    web de forma unívoca.
  \item \negrita{Gestión de clubes: } todas las herramientas
  ...
  \item \negrita{Simulación de partidos: } desarrollaremos un
