...
\item \negrita{Estándar W3C}: Cuando se describe que un sitio o página web cumplen con ciertos estándares web, usualmente quiere decir que la página tiene partes de código HTML, CSS y JavaScript válido o casi válido.
