...
Como resultado del desarrollo del sistema \cursiva{Football Simulator}
...
\cursiva{Football Simulator} es el primer simulador de la gestión de
clubes de fútbol realizado sobre \cursiva{Ruby On Rails} licenciado mediante la
fórmula de software libre, en concreto, liberado bajo licencia \cursiva{GPL}.
...
\item [Aprendizaje de frameworks] A lo largo del desarrollo tuvimos que afrontar
  ...
  programación a la estructura que nos proporciona el \cursiva{framework}
  escogido.
\end{description}
