...
\figura{diagrama_despliegue.png}{scale=0.53}{Diagrama de estructura}{fig:entornoejecucion}{H}
...
\figura{models_complete.png}{scale=0.25}{Diagrama de clases UML de la capa modelo}{diag:clases_modelo}{H}
...
En nuestro sistema hemos decidido que existan 15 tipos de jugadas de ataque, entre ellas, la que marca la
...
jugadores situados en defensa para el equipo que sufre la jugada de gol, respecto a la suma de calidades \cursiva{tácticas} de los
