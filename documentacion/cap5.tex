...
patrón \cursiva{Modelo-Vista-Controlador} (MVC). \\
...
\begin{itemize}
\item \negrita{/pfc\_sfo/} raíz del proyecto \cursiva{Rails}.
\item \negrita{/pfc\_sfo/app/} ficheros fuente principales.
\item \negrita{/pfc\_sfo/app/controllers/} ficheros fuente para los
  controladores.
\item \negrita{/pfc\_sfo/app/helpers/} ficheros fuente para los métodos de ayuda
  para refactorización de códigos en las vistas.
\item \negrita{/pfc\_sfo/app/mailers/} ficheros fuente para el código fuente de
  los correos que se envían desde el servidor.
\item \negrita{/pfc\_sfo/app/models/} ficheros fuente correspondientes a los
  modelos de datos.
\item \negrita{/pfc\_sfo/app/views/} ficheros fuente para las vistas de la
  aplicación, incluyendo como parte de las mismas las de los correos.
\item \negrita{/pfc\_sfo/app/assets/} ficheros fuente que han de ejecutarse en
  el navegador, archivos \cursiva{CSS}, \cursiva{JavasScript}, imágenes, etc...
\item \negrita{/pfc\_sfo/config/}, ficheros fuente de configuración de la
  aplicación web.
\item \negrita{/pfc\_sfo/config/environments/} ficheros fuente de configuración
  de los distintos entornos, desarrollo, test y producción.
\item \negrita{/pfc\_sfo/config/initializers/} ficheros de inicialización del
  servidor.
\item \negrita{/pfc\_sfo/config/locales/} ficheros \cursiva{YAML} para los
  textos de traducción en diferentes idiomas.
\item \negrita{/pfc\_sfo/db/} ficheros autogenerados dónde se albergan la
  configuración de la Base de Datos.
\item \negrita{/pfc\_sfo/db/migrate/} ficheros para la manipulación de las
  tablas de la base de datos.
\item \negrita{/pfc\_sfo/lib/} ficheros para la extensión de la aplicación con
  otros subsistemas software.
\item \negrita{/pfc\_sfo/log/} ficheros log del servidor.
\item \negrita{/pfc\_sfo/public/} ficheros de acceso público a través del
  enrutador.
\item \negrita{/pfc\_sfo/script/} scripts para la generación automática de
  código y la automatización de procesos.
\item \negrita{/pfc\_sfo/test/} ficheros para almacenar test automáticos.
\end{itemize}
...
\figura{uml.png}{scale=0.38,angle=270}{Diagrama de Clases UML}{diagrama-clases-uml}{H}
...
\figura{diagramas_secuencia/abrir_equipos.png}{scale=0.35}{Diagrama de secuencia
...
\figura{diagramas_secuencia/emitir_oferta_futbolista.png}{scale=0.35}{Diagrama
...
En la figura \ref{diagrama-secuencia-cancelar-oferta-emitida-futbolista} se observa cómo
se recupera la instancia de la oferta emitida y se modifica su estado para
cancelarla.

\figura{diagramas_secuencia/cancelar_oferta_emitida_futbolista.png}{scale=0.35}{Diagrama
...
\figura{diagramas_secuencia/rechazar_oferta_recibida_futbolista.png}{scale=0.35}{Diagrama
...
\figura{diagramas_secuencia/aceptar_oferta_recibida_futbolista.png}{scale=0.35}{Diagrama
...
\figura{diagramas_secuencia/fijar_precio_venta_entradas.png}{scale=0.35}{Diagrama
...
\figura{diagramas_secuencia/planificacion_alineaciones.png}{scale=0.35}{Diagrama
...
\figura{diagramas_secuencia/planificacion_entrenamientos.png}{scale=0.35}{Diagrama
...
\figura{diagramas_secuencia/asignar_club.png}{scale=0.35}{Diagrama de secuencia
...
\figura{diagramas_secuencia/simular_jornadas.png}{scale=0.32,
...
\figura{diagramas_secuencia/comenzar_jornadas.png}{scale=0.43,
...
\figura{diagramas_secuencia/pasar_siguiente_jornada.png}{scale=0.27,
...
\figura{diagramas_secuencia/crear_calendario.png}{scale=0.32,
