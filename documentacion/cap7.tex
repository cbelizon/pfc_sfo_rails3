...
\begin{itemize}
\item \negrita{Multiplataforma}: Compatible con los navegadores web más actuales, ya sean
  móviles, tablets o de escritorio, inclusive para \cursiva{Internet Explorer
    7}.
\item \negrita{Tabla de 12 columnas}: Trae predefinida una plantilla de 12 columnas que
...
\newpage
\figura{full_bootstrap.png}{scale=0.35,angle=270}{Twitter bootstrap maximizado
  en Firefox}{fig:bootstrap1}{H}
